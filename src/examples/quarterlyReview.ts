  ...
  slides: [
    {
      type: 'title',
      title: 'Q2 review',
      subtitle: 'Revenue, pipeline and what changed.',
      meta: 'Example',
    },
    {
      type: 'metrics',
    ...
    },
    {
      ...
      max: 600,
      notes:
        'South is the story: half of last quarter. Ask what happened before drawing conclusions.',
    },
    {
      type: 'timeline',
      title: 'What changed',
      items: [
        {
          ...
          detail: 'Removed the demo call from the funnel.',
        },
        {
          when: 'May',
          title: 'Usage-based pricing',
          detail: 'Small teams stopped churning at the seat cliff.',
        },
