...
clean: ## remove build outputs
	npm run clean; rm -rf app/dist share/datalayer/reactor/apps/decks style src/decksCss.ts
...
build: build-app ## build everything
...
serve: ## serve the decks API and the built interface (datalayer-decks)
	datalayer-decks
